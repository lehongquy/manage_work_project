...
import com.example.managerworkofstatecadres.listNotification.ntObject;
import com.example.managerworkofstatecadres.listVehicle.vehicleRecycleAdapter;
...
String  newName = edtName.getText().toString().trim();
            ...
            databaseReference.child(String.valueOf(user.getTrip())).updateChildren(user.toMap(),(error, ref) ->{
                dialog.dismiss();
            } );
            databaseReference.child(String.valueOf(user.getTrip())).removeValue((error, ref) -> {
